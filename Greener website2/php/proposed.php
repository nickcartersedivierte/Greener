  ...
  <section class="colored-section" id="features">
    ...
    <div class="row">
      ...
      <div class="feature-box col-lg-4">
        ...
        <button type="button" class="active feature-title btn btn-lg btn-outline-light" onclick= "location.href = 'proposed.php'"> Proposed</button>
